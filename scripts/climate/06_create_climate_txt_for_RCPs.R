...
process_scenario <- function(scenario) {
  ...
  # Load the data
  co2_file <- file.path(data_directory, "co2_monthly.csv")
  par_file <- file.path(data_directory, "par_monthly.csv")
  prec_file <- file.path(data_directory, "prec_monthly.csv")
  tasmax_file <- file.path(data_directory, "tasmax_monthly.csv")
  tasmin_file <- file.path(data_directory, "tasmin_monthly.csv")
  # Read the data
