# ==============================================================================
# Script for Processing Climate Data (Precipitation) from NetCDF files
# ==============================================================================
# This script processes precipitation data stored in NetCDF format (precipitation values in kg/m2),
# reprojects the data, crops it to the study region, converts it to Celsius, computes
# the monthly average precipitations, and combines the results into a single data frame.
...
# 4. Converts precipitation from kg/m2 to mm/month.
