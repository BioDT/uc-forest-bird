...
output_directory <- file.path(project_directory, "data", "climate", "rcp45", "HMSC_temp_future")
...
future_file <- file.path(input_directory, "tas_Amon_HadGEM2-ES_rcp45_r2i1p1_208012-210011.nc")

climate_data <- rast(future_file)
...
# for the simulation end year 2100
# ==============================================================================
