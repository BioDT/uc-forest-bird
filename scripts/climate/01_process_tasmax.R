...
process_scenario <- function(scenario) {
  ...
  # Define the input directory where NetCDF climate files (tasmax) are stored
  input_directory <- file.path(project_directory, "data", "climate", scenario, "tasmax")
  ...
  for (nc_file in nc_files) {
    ...
    # Extract the tasmax temperature values, ignoring the xy coordinates
    ...
    # Combine year, month, and monthly tasmax_avg for this file into a single data frame
